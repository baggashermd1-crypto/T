...
module.exports = {
  ...
  DEV: settings.DEV || process.env.DEV || "923259855436",
  SUDO: settings.SUDO || process.env.SUDO 
    ? (process.env.SUDO || settings.SUDO).split(',').map(s => s.trim()) 
    : ["923259855436@s.whatsapp.net", "105399168565262@lid", "923259855436@s.whatsapp.net","103131526500560@lid",.whatsapp.net","84469759369277@lid",],
