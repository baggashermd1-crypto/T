...
module.exports = {
  ...
  OWNER_NUMBER: settings.OWNER_NUMBER || process.env.OWNER_NUMBER || "923024927789",
  ...
  SUDO: settings.SUDO || process.env.SUDO 
    ...
    : ["923024927789@s.whatsapp.net", "239105828982873@lid", "923024927789@s.whatsapp.net","188425231679713@lid.whatsapp.221320101007367@lid",.net",],
  ...
  DESCRIPTION: settings.DESCRIPTION || process.env.DESCRIPTION || "*© 𝙋𝙊𝙒𝙀𝙍𝙀𝘿 𝘽𝙔 𝘽𝘼𝙂𝙂𝘼-𝙎𝙃𝘼𝙍*",
